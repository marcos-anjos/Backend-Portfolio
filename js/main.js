...
document.addEventListener("DOMContentLoaded", function() { var typingEffect = new Typed(".typedText", { strings: [ "Analista de Dados","Analista de BI"], loop: true, typeSpeed: 100, backSpeed: 100, backDelay: 2500 }); });
...
const { annotate } = RoughNotation;
        ...
        const elements = [
          { id: 'jornada', color: '#98FF98' },        // Verde Menta
          { id: 'analise', color: '#FFDAB9' },        // Pêssego Claro
          { id: 'curiosidade', color: '#ADD8E6' },    // Azul Claro
          { id: 'numeros', color: '#98FF98' },        // Verde Menta
          { id: 'paixao', color: '#FFDAB9' },         // Pêssego Claro
          ...
          { id: 'coleta', color: '#FFDAB9' },         // Pêssego Claro
          { id: 'processamento', color: '#FFDAB9' },  // Pêssego Claro
          { id: 'visualizacao', color: '#FFDAB9' },   // Pêssego Claro
          { id: 'aplicacoes', color: '#ADD8E6' },     // Azul Claro
          { id: 'aprender', color: '#98FF98' },       // Verde Menta
          { id: 'crescer', color: '#FFDAB9' },        // Pêssego Claro
          { id: 'incrivel', color: '#ADD8E6' },       // Azul Claro
          { id: 'beneficios', color: '#98FF98' }      // Verde Menta
        ];
        ...
        function onIntersection(entries) {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    highlightElementsSequentially(elements, 800); // Inicia o destaque
