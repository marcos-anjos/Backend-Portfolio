...
document.addEventListener("DOMContentLoaded", function() { var typingEffect = new Typed(".typedText", { strings: [ "Analista de Dados","Analista de BI", "Analista Estatístico em R"], loop: true, typeSpeed: 100, backSpeed: 100, backDelay: 2500 }); });
